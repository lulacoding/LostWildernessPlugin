---
title: Core
description: "RPGCorePlugin infrastructure: ModuleManager, ConfigService, DatabaseProvider, SchedulerService."
tags:
  - system
  - core
status: implemented
...
action: none
---
# Core and player modules

Combined reference for **Core** (bootstrap, `ModuleManager`) and **Player** (profile load, session). Source: PluginV2 module docs.
